...
B<Net::DNS::ToolKit::RR:NULL> appends an NULL resource record to a DNS packet under
construction, recovers an NULL resource record from a packet being decoded, and 
...
I<This is probably not correct. An entire resource record + question, etc...
info must fit inside the 65535 record because that is the limitation imposed
by TCP window size. See: extra_docs/draft-ietf-dnsext-axfr-clarify-05.txt
section 3.1>
...
=item * @stuff = $get->NULL(\$buffer,$offset);
