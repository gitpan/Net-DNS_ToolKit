...
Net::DNS::ToolKit::RR::MB - Resource Record Handler

=head1 SYNOPSIS

  DO NOT use Net::DNS::ToolKit::RR::MB
...
B<Net::DNS::ToolKit::RR:MB> appends an MB resource record to a DNS packet under
construction, recovers an MB resource record from a packet being decoded, and 
...
=item * @stuff = $get->MB(\$buffer,$offset);
...
=item * (@COMMON,$MADNAME) = $parse->MB(@common,$madname);
...
For MB RR's, this returns the $madname terminated with '.'

  input:	MB Domain Name
  returns:	MB Domain Name.
